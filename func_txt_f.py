...
Quotes1 = {1: "Мова програмування:computer::computer::computer: <<Чмухтон>>:dash::dash::snake:"
              ...
              "вже скоро зроблять калік с автозабивкою дабл еппл:green_apple::apple:(podviyne yabluko)"
           ...
           2: "Програмісти пустують :call_me_tone1: :smiling_imp:"
              ...
              "Калік всіх тішить: і качків, і чотириоких) Головне дмухати с кайфом пацани:point_up_tone1: "
              "І неважливо, якої ти національності:blush: аби не кацап:warning: :warning:",
           3: "Оце Ікс-колюмбокс:flushed::scream_cat: Одразу видно що Філ (Spencer) довго готував забивочку "
              ...
              "примчить и вдихне дим через мундштучеллу:stuck_out_tongue_winking_eye: по самі гланди:drooling_face:"
              ":underage: Поважайте традиції:point_up_tone1:"
              "Не ведіться на хитрощі:triumph: брудних (dirty) сонібоїв "
              ":nauseated_face::face_with_symbols_over_mouth:Пам'ятайте браття, що наш СПІВВІТЧИЗНИК:flag_mu: Пихфуцій "
           ...
           4: "Кіберчмухи тут?:sunglasses::mechanical_arm::sunglasses:"
              ...
              "Ось і поляки:flag_mu: так вважають, тому додали такого красунчика в Найт-Сіти"
